...
Possible future improvements. These are ideas, not promises.
...
- Track the tested WARNO version and YSM x WiF x WTO Workshop update date in release notes.
- Add a small sample file with only one NATO and one PACT deck for easier smoke testing.

## Documentation

- Add screenshots or a short GIF of calibration and import.
- Add a Steam-friendly quick-start snippet for users who do not use GitHub often.
